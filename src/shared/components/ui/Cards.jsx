...
export default function CardItem({
  ...
  return (
    <article className="group relative flex w-full  flex-col overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-2xl">
      {/* badge */}
      {badge && (
